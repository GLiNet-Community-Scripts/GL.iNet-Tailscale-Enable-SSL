...
```bash
wget -q https://raw.githubusercontent.com/techrelay/GL.iNet-Tailscale-Enable-SSL/main/tailscale-ssl-kvm.sh -O tailscale-ssl-kvm.sh ; sh tailscale-ssl-kvm.sh
```
